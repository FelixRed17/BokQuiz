...
import styles from "./FifaGameHost.module.css";
import { useCreateGame } from "./hooks/useCreateGame";

export default function FifaGameHost() {
    ...
    >
      <div className={`${styles.card} w-100`}>
        <div className={styles.header}>
          <h2 className="mb-0">FIFA Quiz Host</h2>
            ...
            >
              {isLoading ? (
                <>
                  ...
                  <span style={{ marginLeft: 8 }}>Creating FIFA Quiz...</span>
                </>
              ) : (
                "Create FIFA Quiz Session"
              )}
            </button>
          </form>
